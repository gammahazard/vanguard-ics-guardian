import { readFile } from './shims/sensor-fs.js';
import { sendTelemetry } from './shims/sensor-net.js';
import { log } from './shims/sensor-utils.js';
import { environment, exit as exit$1, stderr, stdin, stdout } from './shims/preview2-shim/cli.js';
import { preopens, types } from './shims/preview2-shim/filesystem.js';
import { error, streams } from './shims/preview2-shim/io.js';
...
function trampoline8(arg0, arg1) {
  ...
  _debugLog('[iface="vanguard:containment/sensor-utils@0.1.0", function="log"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'log');
  log(result0);
  _debugLog('[iface="vanguard:containment/sensor-utils@0.1.0", function="log"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  _debugLog('[iface="vanguard:containment/sensor-utils@0.1.0", function="log"][Instruction::Return]', {
    funcName: 'log',
    paramCount: 0,
    async: false,
    postReturn: false
...
function trampoline9(arg0, arg1, arg2) {
  ...
  var len0 = arg1;
  var result0 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  _debugLog('[iface="vanguard:containment/sensor-fs@0.1.0", function="read-file"] [Instruction::CallInterface] (async? sync, @ enter)');
  ...
  _debugLog('[iface="vanguard:containment/sensor-fs@0.1.0", function="read-file"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  var variant3 = ret;
  switch (variant3.tag) {
    case 'ok': {
  ...
  _debugLog('[iface="vanguard:containment/sensor-fs@0.1.0", function="read-file"][Instruction::Return]', {
    funcName: 'read-file',
    paramCount: 0,
    async: false,
    postReturn: false
...
function trampoline10(arg0, arg1, arg2) {
  ...
  var len0 = arg1;
  var result0 = utf8Decoder.decode(new Uint8Array(memory0.buffer, ptr0, len0));
  _debugLog('[iface="vanguard:containment/sensor-net@0.1.0", function="send-telemetry"] [Instruction::CallInterface] (async? sync, @ enter)');
  const _interface_call_currentTaskID = startCurrentTask(0, false, 'send-telemetry');
  let ret;
  try {
    ret = { tag: 'ok', val: sendTelemetry(result0) };
  } catch (e) {
    ret = { tag: 'err', val: getErrorPayload(e) };
  }
  _debugLog('[iface="vanguard:containment/sensor-net@0.1.0", function="send-telemetry"] [Instruction::CallInterface] (sync, @ post-call)');
  endCurrentTask(0);
  var variant2 = ret;
  switch (variant2.tag) {
    case 'ok': {
  ...
  _debugLog('[iface="vanguard:containment/sensor-net@0.1.0", function="send-telemetry"][Instruction::Return]', {
    funcName: 'send-telemetry',
    paramCount: 0,
    async: false,
    postReturn: false
  });
...
const $init = (() => {
  let gen = (function* _initGenerator() {
    const module0 = fetchCompile(new URL('./malicious_driver.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./malicious_driver.core2.wasm', import.meta.url));
    const module2 = base64Compile('');
    const module3 = base64Compile('');
    ({ exports: exports0 } = yield instantiateCore(yield module2));
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      'vanguard:containment/sensor-fs@0.1.0': {
        'read-file': exports0['1'],
      },
      'vanguard:containment/sensor-net@0.1.0': {
        'send-telemetry': exports0['2'],
      },
      'vanguard:containment/sensor-utils@0.1.0': {
        log: exports0['0'],
      },
